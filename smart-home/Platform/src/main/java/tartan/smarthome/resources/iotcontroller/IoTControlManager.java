...
public class IoTControlManager {
    ...
    public void loadSettings() {
        ...
        Boolean lockPassCodeState = Boolean.parseBoolean(props.getProperty(IoTValues.LOCK_PASSCODE_STATE, "true"));
        String lockPassCode = props.getProperty(IoTValues.LOCK_PASSCODE, "1234");
        ...
        initialSettings.put(IoTValues.LOCK_PASSCODE_STATE, lockPassCodeState);
