...
public class TartanHomeData {
    ...
    @Column(name = "resident_proximity_state")
    private String residentProximity;

    // the state of the proximity sensor (true of address occupied, false if vacant)
    @Column(name = "intruder_proximity_state")
    ...
    //TODO did we need to add the stuff from the assignment 2 here as well and just missed it?
    ...
    public TartanHomeData(TartanHome h) {
        ...
        this.residentProximity = h.getResidentProximity();
        this.intruderProximity = h.getIntruderProximity();
